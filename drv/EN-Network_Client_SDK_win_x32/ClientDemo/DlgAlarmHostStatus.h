...
public:
    ...
    NET_DVR_ALARMHOST_MAIN_STATUS   m_struAlarmMainStatus;
...
public :
    ...
    BOOL GetAlarmHostMainStatus(NET_DVR_ALARMHOST_MAIN_STATUS& struAlarmMainStatus);
    BOOL GetAlarmHostOtherStatus(NET_DVR_ALARMHOST_OTHER_STATUS& struAlarmOtherStatus);

    void SetAlarmHostMainStatusToWnd(NET_DVR_ALARMHOST_MAIN_STATUS& struAlarmMainStatus);
