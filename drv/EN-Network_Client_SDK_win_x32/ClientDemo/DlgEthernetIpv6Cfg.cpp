...
BOOL CDlgEthernetIpv6Cfg::OnInitDialog() 
{
	...
	m_EthernetIpv6Cfglist.InsertColumn(0, "序号", LVCFMT_LEFT, 60, -1);
	m_EthernetIpv6Cfglist.InsertColumn(1, "IPV6状态", LVCFMT_LEFT, 120, -1);
	m_EthernetIpv6Cfglist.InsertColumn(2, "IPv6地址", LVCFMT_LEFT, 300, -1);
...
void CDlgEthernetIpv6Cfg::AddEthernetIPV6InfoToDlg(LPNET_DVR_ETHERNET_IPV6_CFG lpInter)
{
	...
	{
		m_EthernetIpv6Cfglist.SetItemText(iCount, 1, "路由公告");
	} 
	else
	{
		m_EthernetIpv6Cfglist.SetItemText(iCount, 1, "自动设置");
	}
