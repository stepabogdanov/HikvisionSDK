...
class CDlgAlarmHostZoomAddr : public CDialog
{
// Construction
public:
	CDlgAlarmHostZoomAddr(CWnd* pParent = NULL);   // standard constructor
	~CDlgAlarmHostZoomAddr();
	...
	int m_iStruCount;
// Dialog Data
	//{{AFX_DATA(CDlgAlarmHostZoomAddr)
	enum { IDD = IDD_DLG_ALARMHOST_ZOOM_ADDR };
	CButton	m_btnGet;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgAlarmHostZoomAddr)
	protected:
