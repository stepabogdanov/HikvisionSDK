...
public:
	...
	BOOL m_bSetChannelPara[MAX_CHANNUM_V30*2];
	BOOL m_bGetChannelPara[MAX_CHANNUM_V30*2];

	NET_DVR_MULTI_STREAM_COMPRESSIONCFG_COND m_struMSCond[4];
	NET_DVR_MULTI_STREAM_COMPRESSIONCFG m_struMSCompressionCfg[MAX_CHANNUM_V30*2][4];
...
// 	NET_DVR_COMPRESSIONCFG_EX m_struCompressionCfg[MAX_CHANNUM_V30];
	NET_DVR_RECORD_V30	m_struRemoteRecCfg[MAX_CHANNUM_V30*2];
	NET_DVR_PICCFG_V30	m_struPicCfg[MAX_CHANNUM_V30*2];
	NET_DVR_AUDIO_INPUT_PARAM m_struAudioIn[MAX_CHANNUM_V30*2];

	NET_DVR_POE_CHANNEL_ADD_MODE m_struPOEAdapterType[MAX_CHANNUM_V30*2];

	NET_DVR_STREAM_CABAC m_struCabac[MAX_CHANNUM_V30*2];

	BOOL m_bRemoteRecord[MAX_CHANNUM_V30*2];
	int m_iDeviceIndex;
