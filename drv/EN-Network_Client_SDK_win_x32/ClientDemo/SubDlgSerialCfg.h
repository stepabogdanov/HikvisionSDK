...
public:
	...
	NET_DVR_DECODERCFG_V30	m_stru485DecoderCfg[MAX_CHANNUM_V30]; //485 port PTZ parameter
	int m_i485ChannelNO[MAX_CHANNUM_V30]; 
	NET_DVR_RS232CFG_V30	m_struRS232Cfg;		//232 port parameter
	NET_DVR_PTZCFG	m_struPtzCfg;		//PTZ
	BOOL m_bGet232Serial;
	BOOL m_bGet485Serial[MAX_CHANNUM_V30];	
	BOOL m_bSet485Serial[MAX_CHANNUM_V30];
