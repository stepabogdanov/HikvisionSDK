...
void CDlgITSWorkState::OnBtnGet() 
{
	...
	if (!NET_DVR_GetDeviceStatus(g_struDeviceInfo[m_iDeviceIndex].lLoginID, NET_ITS_GET_WORKSTATE, dwChannel, NULL,0,&dwStatus,&m_struWorkState,sizeof(m_struWorkState)))
	{
