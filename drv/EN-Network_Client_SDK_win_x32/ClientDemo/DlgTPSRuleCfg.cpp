...
{
    BOOL bRet = FALSE;
    if (!NET_DVR_SetDVRConfig(m_lServerID, NET_DVR_SET_TPS_RULECFG, m_lChannel, &m_struTPSRuleCfg, sizeof(m_struTPSRuleCfg)))
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_SET_TPS_RULECFG Chan[%d]", m_lChannel);
        bRet = FALSE;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_SET_TPS_RULECFG Chan[%d]", m_lChannel);
        bRet = TRUE;
    }
    return bRet;
}
...
BOOL CDlgTPSRuleCfg::GetTPSRuleCfg()
{
    DWORD dwReturn = 0;
    BOOL bRet = FALSE;
    if (!NET_DVR_GetDVRConfig(m_lServerID, NET_DVR_GET_TPS_RULECFG, m_lChannel, &m_struTPSRuleCfg, sizeof(m_struTPSRuleCfg), &dwReturn))
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_GET_TPS_RULECFG Chan[%d]", m_lChannel);
        bRet = FALSE;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_GET_TPS_RULECFG Chan[%d]", m_lChannel);
        bRet = TRUE;
    }
    return bRet;
}

BOOL CDlgTPSRuleCfg::SetTPSRuleToWnd(NET_DVR_TPS_RULECFG const &struTpsRule)
{
...
BOOL CDlgTPSRuleCfg::GetTPSRuleFromWnd(NET_DVR_TPS_RULECFG  &struTpsRule)
{
    GetOneTpsRuleFromWnd(struTpsRule.struOneTpsRule[m_iTPSIndex]);
    return TRUE;
}

BOOL CDlgTPSRuleCfg::SetOneTpsRuleToWnd(NET_DVR_ONE_TPS_RULE const &struOneTpsRule)
{
...
BOOL CDlgTPSRuleCfg::GetOneTpsRuleFromWnd(NET_DVR_ONE_TPS_RULE &struOneTpsRule)
{
...
BOOL CDlgTPSRuleCfg::ShowTimeParam()
{
...
void CDlgTPSRuleCfg::OnSelchangeComboweekday() 
{
    ...
    m_iHour11 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStartHour;
    m_iMin11 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStartMin;
    m_iHour12 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStopHour;
    m_iMin12 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStopMin;
    m_iHour21 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStartHour;
    m_iMin21 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStartMin;
    m_iHour22 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStopHour;
    m_iMin22 = m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStopMin;
    UpdateData(FALSE);
}
...
void CDlgTPSRuleCfg::SetTimePara()
{
    int i;
    i = m_comboWeekday.GetCurSel();	
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStartHour = (BYTE)m_iHour11;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStartMin = (BYTE)m_iMin11;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStopHour = (BYTE)m_iHour12;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][0].byStopMin = (BYTE)m_iMin12;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStartHour = (BYTE)m_iHour21;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStartMin = (BYTE)m_iMin21;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStopHour = (BYTE)m_iHour22;
    m_struTPSRuleCfg.struOneTpsRule[m_iTPSIndex].struAlarmTime[i][1].byStopMin = (BYTE)m_iMin22;
}
