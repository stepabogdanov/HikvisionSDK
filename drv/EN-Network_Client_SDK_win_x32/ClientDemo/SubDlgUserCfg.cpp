...
BOOL CSubDlgUserCfg::CfgSetup()
{
	if (m_bSetUserParams)
	{
		...
		{
			g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_SET_USERCFG_V30"); 
			char szLan[128] = {0};
...
void CSubDlgUserCfg::OnBnClickedBtnUserOk()
{
	...
	{
		strncpy((char *)m_struUserCfg.struUser[m_iUserIndex].struUserIP.byIPv6, m_csUserIP, 128);
	}
	else
	{
	...
	m_struUserCfg.struUser[m_iUserIndex].byPriority = (BYTE)m_comboPriority.GetCurSel();
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[0] = (BYTE)m_bChkLocalPTZCtrl;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[1] = (BYTE)m_bChkLocalRecManul;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[2] = (BYTE)m_bChkLocalPlayBack;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[3] = (BYTE)m_bChkLocalSetParam;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[4] = (BYTE)m_bChkLocalShowStat;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[5] = (BYTE)m_bChkLocalHighOperation;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[7] = (BYTE)m_bChkLocalCameraManage;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[8] = (BYTE)m_bChkLocalBackup;
	m_struUserCfg.struUser[m_iUserIndex].byLocalRight[9] = (BYTE)m_bChkLocalReboot;

	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[0] = (BYTE)m_bChkRemotePTZCtrl;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[1] = (BYTE)m_bChkRemoteRecManul;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[2] = (BYTE)m_bChkRemotePlayBack;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[3] = (BYTE)m_bChkRemoteSetParam;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[4] = (BYTE)m_bChkRemoteShowStat;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[5] = (BYTE)m_bChkRemoteHighOperation;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[6] = (BYTE)m_bChkRemoteVoiceTalk;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[7] = (BYTE)m_bChkRemotePreview;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[8] = (BYTE)m_bChkRemoteAlarm;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[9] = (BYTE)m_bChkRemoteLocalOut;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[10] = (BYTE)m_bChkRemoteSerialCtrl;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[12] = (BYTE)m_bChkNetCameraManage;
	m_struUserCfg.struUser[m_iUserIndex].byRemoteRight[13] = (BYTE)m_bChkNetReboot;
    m_struUserCfg.struUser[m_iUserIndex].byAlarmOnRight = m_bAlarmOn;
    m_struUserCfg.struUser[m_iUserIndex].byAlarmOffRight = m_bAlarmOff;
    m_struUserCfg.struUser[m_iUserIndex].byBypassRight = m_bBypass;
...
void CSubDlgUserCfg::OnCbnSelchangeComboUserSel()
{
	...
	if (strlen((char *)m_struUserCfg.struUser[m_iUserIndex].struUserIP.byIPv6) != 0 && strlen((char *)m_struUserCfg.struUser[m_iUserIndex].struUserIP.byIPv6) != 2)
	{
		m_csUserIP.Format("%s", m_struUserCfg.struUser[m_iUserIndex].struUserIP.byIPv6);
	}
	else
	{
    ...
    m_bAlarmOn = m_struUserCfg.struUser[m_iUserIndex].byAlarmOnRight;
    m_bAlarmOff = m_struUserCfg.struUser[m_iUserIndex].byAlarmOffRight;
    m_bBypass = m_struUserCfg.struUser[m_iUserIndex].byBypassRight;
...
void CSubDlgUserCfg::OnBnClickedBtnRemoteChanOk()
{
	...
	for (i=0; i<MAX_CHANNUM_V30; i++)
	{
		byRight[i] = (BYTE)m_bRemoteChan[i];
	}
	switch(m_iSelNetRightType)
	{
	case 0:
