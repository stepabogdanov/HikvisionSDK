...
/////////////////////////////////////////////////////////////////////////////
// CDlgAlarmHostZoomAddr dialog

DWORD WINAPI CDlgAlarmHostZoomAddr::GetZoomListThread(LPVOID lpArg)
{
	CDlgAlarmHostZoomAddr* pThis = reinterpret_cast<CDlgAlarmHostZoomAddr*>(lpArg);
...
CDlgAlarmHostZoomAddr::CDlgAlarmHostZoomAddr(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgAlarmHostZoomAddr::IDD, pParent)
	,m_iLastItem(-1)
	, m_lHandle(-1)
	, m_iDeviceIndex(-1)
	, m_lUserID(-1)
	...
	, m_iZoomCount(0)
{
	//{{AFX_DATA_INIT(CDlgAlarmHostZoomAddr)
	//}}AFX_DATA_INIT
}

CDlgAlarmHostZoomAddr::~CDlgAlarmHostZoomAddr()
{
	delete[] m_lpStruAlarmIn;
	m_lpStruAlarmIn = NULL;
}
void CDlgAlarmHostZoomAddr::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgAlarmHostZoomAddr)
...
BEGIN_MESSAGE_MAP(CDlgAlarmHostZoomAddr, CDialog)
	//{{AFX_MSG_MAP(CDlgAlarmHostZoomAddr)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgAlarmHostZoomAddr message handlers

BOOL CDlgAlarmHostZoomAddr::OnInitDialog() 
{
...
void CDlgAlarmHostZoomAddr::OnDblclkListZoom(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CDlgAlarmHostZoomAddr::OnKillfocusEditText() 
{
	// TODO: Add your control notification handler code here
	CString  csEditStr;
...
void CDlgAlarmHostZoomAddr::SaveZoomInfo() 
{
	char  szStr[128] = {0};
	//模块地址
...
void CDlgAlarmHostZoomAddr::OnSelchangeComboSubsystemIndex() 
{
	// TODO: Add your control notification handler code here
	//OnBtnGet();
}

void CDlgAlarmHostZoomAddr::AddZoomInfoToDlg(LPNET_DVR_ALARMIN_PARAM lpInter) 
{
	char szStr[128] = {0};
	//防区号
	...
	{
		g_StringLanType(szStr, "本地防区", "LOCAL ZOOM");
	}
	else if (2 == lpInter->byModuleType)
	{
		g_StringLanType(szStr, "单防区", "SINGLE-ZOOM");
	}
	else if (3 == lpInter->byModuleType)
	{
		g_StringLanType(szStr, "双防区", "DOUBLE-ZOOM");
	}
	else if (4 == lpInter->byModuleType)
	{
		g_StringLanType(szStr, "8防区", "8-ZOOM");
	}
	else if (5 == lpInter->byModuleType)
	{
		g_StringLanType(szStr, "8路模拟量防区", "8-ANALOG ZOOM");
	}
	else
	{
...
void CDlgAlarmHostZoomAddr::OnBtnGet() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	char szLan[128] = {0};
...
void CDlgAlarmHostZoomAddr::OnBtnSet() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	char szStr[128] = {0};
...
void CDlgAlarmHostZoomAddr::OnCancel()
{
	m_bGetNext = FALSE;
