...
BOOL CDlgPdcCalibration::SetCalibration()
{
    ...
    m_struCalibrationCfg.byEnable = TRUE;
...
BOOL CDlgPdcCalibration::CaptureBmp()
{
    ...
    struJpegPara.wPicQuality = (WORD)g_struDeviceInfo[m_iDevIndex].struChanInfo[m_lChannel].iPicQuality;
    struJpegPara.wPicSize = (WORD)g_struDeviceInfo[m_iDevIndex].struChanInfo[m_lChannel].iPicResolution;
