...
public:
    ...
    BOOL SetTPSRuleToWnd(NET_DVR_TPS_RULECFG const &struTpsRule);
    BOOL GetTPSRuleFromWnd(NET_DVR_TPS_RULECFG  &struTpsRule);

    
    BOOL SetOneTpsRuleToWnd(NET_DVR_ONE_TPS_RULE const &struOneTpsRule);
    BOOL GetOneTpsRuleFromWnd(NET_DVR_ONE_TPS_RULE &struOneTpsRule);
