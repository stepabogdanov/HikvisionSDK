...
void CDlgAlarmOperatorUser::InitCombox()
{
	...
	g_StringLanType(szLan, "单布防，无布防报告，不能旁路", "It can set up defensive, has no report of remove defensive, can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单撤防，无撤防报告，不能旁路", "It can remove defensive, has no report of remove defensive, can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "布撤防，无布撤防报告，不能旁路", "It can set up and remove defensive, can not receive any report, can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单布防，有布防报告，不能旁路", "It can set up defensive, receive report of set up defensive and can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单撤防，有撤防报告，不能旁路", "It can remove defensive, receive report of remove defensive and can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "布撤防，有布撤防报告，不能旁路", "It can set up and remove defensive, receive any report and can not bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单布防，无布撤防报告，允许旁路", "It can set up defensive, can not receive any report and can bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单撤防，无布撤防报告，允许旁路", "It can remove defensive, can not receive any report and can bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "布撤防，无布撤防报告，允许旁路", "It can set up and remove defensive, an not receive any report and can bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单布防，有布防报告，允许旁路", "It can set up defensive, receive report of set up defensive and can bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "单撤防，有撤防报告，允许旁路", "It can remove defensive, receive report of remove defensive and can bypass");
	m_cmSubsystem.AddString(szLan);
	g_StringLanType(szLan, "布撤防，有布撤防报告，允许旁路", "It can set up and remove defensive, can not receive any report and can bypass");
	m_cmSubsystem.AddString(szLan);
	UpdateData(FALSE);
} 
