...
BOOL CDlgRemoteVideoInLost::OnInitDialog() 
{
	...
	m_bChkEmapAlarmOut = (g_lpVILost->strVILostHandleType.dwHandleType>>6)&0x01;
	m_bChkPicToFtp = (g_lpVILost->strVILostHandleType.dwHandleType>>9)&0x01;
...
void CDlgRemoteVideoInLost::OnBnClickedBtnVilostDayOk()
{
    ...
    {
        g_lpVILost->struAlarmTime[i][0].byStartHour = (BYTE)m_iHour11;
        g_lpVILost->struAlarmTime[i][0].byStartMin = (BYTE)m_iMin11;
        g_lpVILost->struAlarmTime[i][0].byStopHour = (BYTE)m_iHour12;
        g_lpVILost->struAlarmTime[i][0].byStopMin = (BYTE)m_iMin12;
        g_lpVILost->struAlarmTime[i][1].byStartHour = (BYTE)m_iHour21;
        g_lpVILost->struAlarmTime[i][1].byStartMin = (BYTE)m_iMin21;
        g_lpVILost->struAlarmTime[i][1].byStopHour = (BYTE)m_iHour22;
        g_lpVILost->struAlarmTime[i][1].byStopMin = (BYTE)m_iMin22;
        g_lpVILost->struAlarmTime[i][2].byStartHour = (BYTE)m_iHour31;
        g_lpVILost->struAlarmTime[i][2].byStartMin = (BYTE)m_iMin31;
        g_lpVILost->struAlarmTime[i][2].byStopHour = (BYTE)m_iHour32;
        g_lpVILost->struAlarmTime[i][2].byStopMin = (BYTE)m_iMin32;
        g_lpVILost->struAlarmTime[i][3].byStartHour = (BYTE)m_iHour41;
        g_lpVILost->struAlarmTime[i][3].byStartMin = (BYTE)m_iMin41;
        g_lpVILost->struAlarmTime[i][3].byStopHour = (BYTE)m_iHour42;
        g_lpVILost->struAlarmTime[i][3].byStopMin = (BYTE)m_iMin42;
        g_lpVILost->struAlarmTime[i][4].byStartHour = (BYTE)m_iHour51;
        g_lpVILost->struAlarmTime[i][4].byStartMin = (BYTE)m_iMin51;
        g_lpVILost->struAlarmTime[i][4].byStopHour = (BYTE)m_iHour52;
        g_lpVILost->struAlarmTime[i][4].byStopMin = (BYTE)m_iMin52;
        g_lpVILost->struAlarmTime[i][5].byStartHour = (BYTE)m_iHour61;
        g_lpVILost->struAlarmTime[i][5].byStartMin = (BYTE)m_iMin61;
        g_lpVILost->struAlarmTime[i][5].byStopHour = (BYTE)m_iHour62;
        g_lpVILost->struAlarmTime[i][5].byStopMin = (BYTE)m_iMin62;
        g_lpVILost->struAlarmTime[i][6].byStartHour = (BYTE)m_iHour71;
        g_lpVILost->struAlarmTime[i][6].byStartMin = (BYTE)m_iMin71;
        g_lpVILost->struAlarmTime[i][6].byStopHour = (BYTE)m_iHour72;
        g_lpVILost->struAlarmTime[i][6].byStopMin = (BYTE)m_iMin72;
        g_lpVILost->struAlarmTime[i][7].byStartHour = (BYTE)m_iHour81;
        g_lpVILost->struAlarmTime[i][7].byStartMin = (BYTE)m_iMin81;
        g_lpVILost->struAlarmTime[i][7].byStopHour = (BYTE)m_iHour82;
        g_lpVILost->struAlarmTime[i][7].byStopMin = (BYTE)m_iMin82;
    }
...
void CDlgRemoteVideoInLost::OnBnClickedBtnVilostDayCopy()
{
    ...
    else if (7 == m_nCopyTime)
    {
        for (k = 0; k < MAX_TIMESEGMENT_V30; k++)
        {
            memcpy(&m_struVLHolidayHandle.struAlarmTime[k], &g_lpVILost->struAlarmTime[i][k], sizeof(NET_DVR_SCHEDTIME));
        }
        if (SetVLHolidayHandle(m_struVLHolidayHandle))
        {
            AfxMessageBox("Fail to set holiday handle");
...
void CDlgRemoteVideoInLost::OnBnClickedBtnVilostOk()
{
	...
	g_lpVILost->strVILostHandleType.dwHandleType |= (m_bChkEmapAlarmOut << 6);
	g_lpVILost->strVILostHandleType.dwHandleType |= (m_bChkPicToFtp << 9);
