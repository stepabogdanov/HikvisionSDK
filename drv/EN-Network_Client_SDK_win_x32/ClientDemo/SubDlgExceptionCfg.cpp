...
// 	}
	...
	{
		g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_GET_EXCEPTIONCFG_V30");
...
void CSubDlgExceptionCfg::OnBnClickedBtnExceptionOk()
{
	...
	for (i=0; i<MAX_ALARMOUT_V30; i++)
	{
		m_struExceptionInfo.struExceptionHandleType[m_iExceptionType].byRelAlarmOut[i] = (BYTE)m_bAlarmOut[i];
	}
...
BOOL CSubDlgExceptionCfg::CfgSetup()
{
	...
	if (m_bSetPara)
	{
		...
		{
			g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_SET_EXCEPTIONCFG_V30"); 
