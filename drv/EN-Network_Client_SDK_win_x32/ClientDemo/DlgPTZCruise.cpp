...
void CDlgPTZCruise::OnCbnSelchangeComboCruiseRoute()
{
	...
	{
		m_bPrivateIPMode = FALSE;
		g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_GetPTZCruise %s cruise[%d] ", g_struDeviceInfo[iDeviceIndex].struChanInfo[iChanIndex].chChanName, m_iCruiseNum);
	}
	else
	{
